...
public class Chart {
   ...
   */
  public Chart(@NotNull Exchange exchange) {
  ...
  public boolean equals(Object o) {
    ...
    Chart chart = (Chart) o;
    return candlestickList.equals(chart.candlestickList) && exchange.equals(
        chart.exchange);
  }

  @Override
  public int hashCode() {
    return Objects.hash(candlestickList, exchange);
  }

  @Override
  public String toString() {
    return "Chart{" + "candlestickList=" + candlestickList + ", exchange=" + exchange
        + '}';
  }
}
